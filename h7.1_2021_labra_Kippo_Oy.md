...
> - Selaimella `localhost/admin` toimi, mutta kirjautuminen tyssää `server error 500`. Tarkistan lokit, joka kertoo että conf tiedoston listaamissa poluissa on oikeusvirheitä. Korjaan ja samalla luon ryhmän ampari joka saa moukkausoikeudet, jäseniä ei ole pyydetty mutta testauksen vuoksi lisäsin arnoldin ryhmään.
