...
6. [ampari.example.com](https://github.com/syjaka/Linux-Palvelimet-2024/blob/main/h7.1_2021_labra_Kippo_Oy.md#6-ampariexamplecom------jbclkpq8npjbfu6ow6so)
...
8. [Tietokanta](https://github.com/syjaka/Linux-Palvelimet-2024/blob/main/h7.1_2021_labra_Kippo_Oy.md#8-tietokanta)
9. [Analyysi](https://github.com/syjaka/Linux-Palvelimet-2024/blob/main/h7.1_2021_labra_Kippo_Oy.md#9-analysis)
10. [Lisää kippoja](https://github.com/syjaka/Linux-Palvelimet-2024/blob/main/h7.1_2021_labra_Kippo_Oy.md#10-lis%C3%A4%C3%A4-kippoja)
...
>  -  ![7.1_2021_1_ssh_vastaa](https://github.com/syjaka/Linux-Palvelimet-2024/blob/main/images/7.1_2021_1_ssh_vastaa.png)
  - Luo käyttäjät ja listaa käyttäjätunnukset ja salasanat aiemmin tekemääsi lab.txt tiedostoon, tässä tapauksessa kun tiedostoa ei palauteta ne ovat tässä.
...
Tee Python Flaskilla palvelu, josta löytyy muutama osoite.
  - Ensin luon Djangoon staattisesti vastaavan localhost sivun joka alkaa apin luonnilla. Tämä osio on kokonaisuudessan tehty educative.io sivuston ohjeilla a.
    ...
    > - Loin apin djangoon ja osoitin sen projekti-amparin hakemistoon. `python manage.py startapp ampariappi`loi appin.
    > - Lisäsin `(env) kadriye@KippoOy:~/publicwsgi/ampari/ampari/settings.py` tiedoston INSTALLED_APPS kohtaan `ampariappi`.
    > - Seuraavaksi loin näkymän `ampariappille` appin hakemistossa sijaitsevaan `views.py` tiedostoon, jonka tallensin seuraavanlaisena:
    ...
    >  Apin toimiessa loin HTML sivun. Tämä osio on kokonaisuudessan tehty educative.io sivuston ohjeilla b.
    ...
    Kun meillä on toimiva html sivu luon seuraavaksi kaksi pyydettyä sivua. Tämä osio on ttoteutueetu Tero Karvisen [Django cheatsheet](https://terokarvinen.com/2023/django-cheatsheet/) sivun avulla.
    ...
    > - ampari.example.com asettamiseen vastaamaan selaimessa olikin hämmästyttävän löytää ohjeita. Lopouksi otin ChatGPTn apuun jonka ohjeita testaan alla:
...
Näiden jatkoksi end of internettikään ei enää apuja tarjonnut, ainoat ehdotukset mitä löytyivät koskivat yö tarkistettuja, joten luovutan tämän osalta osittain ajanpuutteenkin vuoksi.
...
> [`curl -H 'Host: kippo.example.com' localhost`](7.1_2021_25_kippo kurlaa)
> [`curl -H 'Host: sanko.example.com' localhost`](7.1_2021_25_sanko_kurlaa)
> [`curl -H 'Host: ampari.example.com' localhost`](7.1_2021_25_ampari_kurlaa)
