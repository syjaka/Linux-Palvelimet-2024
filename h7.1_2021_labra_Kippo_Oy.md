...
- Seuraavana päivänä 07.03 aloitin Amäpärin kanssa klo 12.30 ja keskeytin 16.00 ja jatkoin 20.00 ja lopetin 00.45. Jolloin sain ampariappin vastaamaan. Työaika yhteensä 8 h 15 min.
- Perjantaina aloitin 11.00 ja klo 13.05 sain localhostin vastaamaan staattisella verkkosivulla. Luovutin onnistumisen Amparin suhteen 19.50. työaika yhteensä 8 h 50 min. Tähän mennessä tehtyjä tunteja 25 h 35 min. Mihinkähän muuhun sitä lomaa käyttäisi :)
...
Tee Python Flaskilla palvelu, josta löytyy muutama osoite.
  - Ensin luon Djangoon staattisesti vastaavan localhost sivun joka alkaa apin luonnilla. Tämä osio on kokonaisuudessan tehty educative.io sivuston ohjeilla a.
    ...
    >   > ![ 7.1_2021_19_django_html_vastaa]()
    ...
    >   > ![7.1_2021_19_localhost ampari vastaa]()
...
> ![7.1_2021_20_example_conf]()
2. [Kaikkien hakemistojen oikeudet](7.1_2021_21_chmod oikeudet)ja [url.py ja views.py oikeudet](7.1_2021_22_chmod_url_view_)
3. view ja url tiedostojen oikeat polut ja [sisällöt](7.1_2021_23_url_view_sis) 
4. Installed apps listaus [settings.py](7.1_2021_24_settings_py)
