...
>   > ![repo6]()
> - Vaihdoin SSH-palvelimen porttiin muokkaamalla komennolla `sudo /etc/ssh/sshd_config` kyseistä tiedostoa, jonna vaihdoin portin 22 tilalle 1337, ja otin määrityksen käyttöön poistamalla # edestä.
...
1. Virtuaalikoneen ja debianin asennus
2. 
