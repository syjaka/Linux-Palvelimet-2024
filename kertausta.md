...
>
4. Yleisiä niksejä/ tee alkuun uudet käyttäjät ja salasanageneraattori
...
>    - `sudo chmod u=rwx,g=rx,o= /polku/kansioon`
...
>     
4. [Apache ja nimipalvelin](https://httpd.apache.org/docs/2.4/vhosts/name-based.html)
